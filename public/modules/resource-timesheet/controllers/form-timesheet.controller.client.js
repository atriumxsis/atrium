...
angular.module('timesheet').controller('FormTimesheetController', ['$scope', '$http', 'DateConverterUtils',
	function($scope, $http, DateConverterUtils) {
		...
		var updateTimesheet = function() {
			...
			$scope.formPromise = $http.post('api/timesheet/update', $scope.timesheet).
